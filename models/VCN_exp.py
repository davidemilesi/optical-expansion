...
class VCN(nn.Module):
    ...
    def forward(self,im,flow_RAFT,usa_RAFT,disc_aux=None):
        bs = im.shape[0]//2
...
#        print('flusso: ', type(flow2))
#        print('flusso: ', flow2.shape)
#        print('occ: ', type(oor2))
#        print('occ: ', oor2.shape)
#        
#        print('c12: ', type(c12))
#        print('c12: ', c12.shape)
#        print('c22: ', type(c22))
...
#        
        ...
        flow_RAFT = F.interpolate(flow_RAFT, (flow2.shape[2],flow2.shape[3]) , mode='bilinear')/4
        
        #print('RAFT max: ', torch.max(flow_RAFT))
        #print('RAFT min: ', torch.min(flow_RAFT))
        #print('FLOW max: ', torch.max(flow2))
        #print('FLOW min: ', torch.min(flow2))
...
#            print('flusso: ', type(flow2))
#            print('flusso: ', flow2.shape)
#            print('occ: ', type(oor2[0]))
#            print('occ: ', oor2[0].shape)
